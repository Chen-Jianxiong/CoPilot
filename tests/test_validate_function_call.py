...
class TestValidateFunctionCall(unittest.TestCase):
    ...
    def test_valid_dynamic_function_call(self):
        ...
        doc1 = Document(
            page_content="Finds dependents of a given microservice...",
            metadata={
        ...
        doc3 = Document(
            page_content="`getVerticesById(vertexType: str, vertexIds: Union[int, str, list])` → Union[list, str, pd.DataFrame]\nRetrieves vertices of the given vertex type, identified by their ID...",
            metadata={
                "source": "./app/pytg_documents/get_vertices_by_id.json",
                "seq_num": 1,
                "function_header": "getVerticesById",
                "description": "Get vertex information by vertex ID",
                "param_types": {
                    "vertexType": "str",
                    "vertexIds": "Union[int, str, List[Union[int, str]]",
                },
                "custom_query": False,
            },
        )
    ...
    def test_valid_buildin_function_call(self):
        ...
        doc3 = Document(
            page_content="`getVertexCount(vertexType: Union[str, list] = '*', where: str = '')` → Union[int, dict]\nReturns the number of vertices of the specified type...",
            metadata={
                "source": "./app/pytg_documents/get_vertex_count.json",
                "seq_num": 1,
